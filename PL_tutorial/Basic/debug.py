#use the summary and one batch for checking the sanity of the models
#use profiler for fathom the deepper details 
#essentials
import os 
import warnings
...
trainer = pl.Trainer(gpus=1 if torch.cuda.is_available() else 0, max_epochs=1, default_root_dir='./checkpoint_saving', callbacks=custom_callbacks,  profiler='simple')
